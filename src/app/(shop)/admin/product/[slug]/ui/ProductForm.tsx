...
import { ProductImage as ImagenProducto } from '@/components/product/producrt-image/ProductImage';
      ...
      <div className='w-full'>
        <div className='flex flex-col mb-2'>
          ...
          <input
            type='number'
            className='p-2 border rounded-md bg-gray-200'
            {...register('inStock', { required: true, minLength: 0 })}
          />
        </div>
        {/* As checkboxes */}
            ...
            {sizes.map((size) => (
              ...
              <div
                ...
                className={clsx(
                  ...
                  {
                    'bg-blue-500 text-white': getValues(
                      'sizes'
                    ).includes(size),
                  }
                )}
